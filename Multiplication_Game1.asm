.data
	...
	SCORE_TABLE: .word 1, 10, 100, 1000 # Heuristic score table   
.text
Main:
	li $v0, 4
	la $a0, Newline
...
rowLoop:  
    	lw $t1, 0($t3)
    	beq $t1, 88, scoreComp
    	beq $t1, 111, scorePlayer   
    	addi $t3, $t3 4
    	blt $t3, 144, rowLoop

scoreComp:
    	jal countStreak
    	lw $t1, SCORE_TABLE($v0)
    	add $v0, $v0, $t1 
...
gameLoop:
    	move $a0, $s0 
    	jal evaluatePosition   
    	blt $v0, $s1, skipUpdate
    	move $s1, $v0 
    	move $s2, $s3
